...
internal static class LoadPromptControllerFactory {
  internal static KeyboardController CreateKeyboardController(Game1 game, StateLoadPromptType loadPrompt) {
  ...
  internal static GamePadController CreateGamePadController(Game1 game, StateLoadPromptType loadPrompt) {
