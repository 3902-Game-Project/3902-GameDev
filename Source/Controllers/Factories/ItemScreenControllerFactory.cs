...
internal static class ItemScreenControllerFactory {
  internal static KeyboardController CreateKeyboardController(Game1 game, StateItemScreenType itemScreen, Player player) {
  ...
  internal static GamePadController CreateGamePadController(Game1 game, StateItemScreenType itemScreen, Player player) {
