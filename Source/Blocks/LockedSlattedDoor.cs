...
public class LockedSlattedDoorBlock : BaseBlock {
  private Texture2D texture;
  private Rectangle sourceRect;
  public float Rotation { get; private set; }
  public string PairedLevelName { get; private set; }

  public LockedSlattedDoorBlock(Texture2D LockedSlattedDoorTexture, Vector2 xyPos, string pairedLevelName) : base(xyPos) {
