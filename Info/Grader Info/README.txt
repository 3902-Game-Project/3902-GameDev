...
Code Metrics:
  ...
  Graph at "Info/Grader Info/Code Metrics/Sprint 5" folder

Code Reviews:
  Found in the "Info/Grader Info/Code Review/Sprint 5" folder.
...
Known bugs:
  ...
  -Items the player consumed were not stored by the save/load system.
  -Can go through door while level is still fading in, causes game crash.
